...
class OpenRouterAdapter(
    ...
    override suspend fun sendMessage(apiKey: String, model: String, content: String, systemPrompt: String): String {
        ...
        val response = service.getChatCompletionWithExtraHeaders(
            url = baseUrl,
    ...
    override fun streamMessage(apiKey: String, model: String, content: String, systemPrompt: String): Flow<String> = callbackFlow {
        ...
        val request = Request.Builder()
            ...
            .addHeader("HTTP-Referer", "https://github.com/ayaan/nexoraid")
            .addHeader("X-Title", "Nexoraid App")
    ...
    override suspend fun listModels(apiKey: String): List<String> {
        // Hardcoded or use models endpoint. Let's hardcode a few for now or leave it generic.
        return listOf("openai/gpt-3.5-turbo", "anthropic/claude-3-haiku-20240307", "google/gemini-1.5-flash", "nvidia/nemotron-3-nano-30b-a3b:free")
    }
